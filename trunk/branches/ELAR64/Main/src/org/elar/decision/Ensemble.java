...
public class Ensemble {
	...
	private static void trainDP() throws Exception{
		try{
			...
			CvMat ann = new CvMat(cvLoad(DB_PATH+"GlANNcv1.xml")); pms.add(ann);
			CvMat cf = new CvMat(cvLoad(DB_PATH+"GlKNNcv1.xml"));   pms.add(cf);
                        CvMat svm = new CvMat(cvLoad(DB_PATH+"GlSVMcv1.xml")); pms.add(svm);
